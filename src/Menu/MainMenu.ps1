...
function Get-GlobalSearchCatalog {
    return @(
        ...
        [PSCustomObject]@{ Script = "ClientToolsMenu.ps1"; RunScript = "ClientToolsMenu.ps1"; RunOption = "U9"; Area = "Windows Client Tools > Utilities"; Item = "Install VirtIO guest tools (Proxmox VM)"; Keywords = "virtio proxmox vm guest tools drivers redhat winget install" },
